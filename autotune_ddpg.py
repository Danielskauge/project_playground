...
class Buffer:
    ...
    def learn(self, actor_model, critic_model, target_actor, target_critic, actor_optimizer, critic_optimizer, gamma):
        ...
        self.update(state_batch, action_batch, reward_batch, next_state_batch, actor_model, critic_model, target_actor, actor_optimizer, critic_optimizer, target_critic, gamma)
...
def loss_given_hyperparams(critic_lr, actor_lr, total_episodes, gamma, tau, hidden_layers_shape, buffer_size, batch_size, noise_std_dev):
    ...
    for ep in range(total_episodes):
        ...
        while True:
            ...
            buffer.learn(actor_model, critic_model,
                         target_actor, target_critic, actor_optimizer, critic_optimizer, gamma)
...
def calculate_optimal_params():
    ...
    space = hp.lognormal('tau', 0.001, 0.01)

    best = fmin(loss_given_hyperparams(critic_lr, actor_lr, total_episodes, gamma, tau, hidden_layers_shape,
                                       buffer_size, batch_size, noise_std_dev), space, algo=tpe.suggest, max_evals=100)
